...
$hero_title_format = pll__('Category: <span class="text-transparent bg-clip-text bg-gradient-to-r from-primary-light to-teal-300">%s</span>');
...
<main class="flex-grow">
  ...
  <section class="relative bg-[#041424] min-h-[400px] flex flex-col justify-end pb-16 overflow-hidden">
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full text-center pt-36">
      ...
      <nav class="flex items-center justify-center gap-2 mb-4 text-xs font-semibold text-white/50 tracking-wider uppercase font-sans">
        ...
        <a href="<?php echo esc_url(home_url('/news')); ?>" class="hover:text-primary-light transition-colors duration-200"><?php echo esc_html(pll__('News & Events')); ?></a>
        <span class="text-white/30 font-light">/</span>
        <span class="text-white/85"><?php echo esc_html(pll__($cat_title)); ?></span>
      </nav>
      ...
      <p class="max-w-2xl mx-auto text-base sm:text-lg text-white/70 font-normal leading-relaxed">
        <?php echo wp_kses_post(pll__($hero_subtitle)); ?>
      </p>
    </div>
  </section>
  ...
  <section class="py-16 pb-24 bg-[#F4F7FE]">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <?php else: ?>
        <p class="text-center text-slate-500 font-semibold py-12"><?php echo esc_html(pll__('No articles found in this category.')); ?></p>
      <?php endif; ?>
