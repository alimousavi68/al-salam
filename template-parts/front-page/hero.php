...
<section id="home" class="relative bg-background-page pt-3 pb-3 sm:pt-4 sm:pb-6 lg:pt-4 lg:pb-8">
  <div class="max-w-[1440px] mx-auto px-2 sm:px-4 lg:px-8">
    ...
    <div id="hero-wrapper" class="hero-container relative overflow-hidden rounded-[1.5rem] sm:rounded-[2rem] lg:rounded-[3rem] min-h-[620px] sm:min-h-[700px] lg:min-h-[800px] flex flex-col justify-between shadow-2xl" style="min-height: 97dvh;">
      ...
      <div class="absolute bottom-8 end-8 sm:bottom-12 sm:end-12 z-30">
