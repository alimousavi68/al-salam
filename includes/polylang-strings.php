...
function alsalam_register_polylang_strings() {
    ...
    $static_strings = [
        ...
        'Sterile API',
        '<span class="text-teal-500">Excellence</span> <br/> in Parenteral Manufacturing',
        '<span class="text-teal-600 block"><span class="text-teal-600">Sterile</span> <span class="text-slate-900">Solutions</span></span><span class="text-slate-900 block mt-1">Reliable</span>',
        'About <span class="text-transparent bg-clip-text bg-gradient-to-r from-primary-light to-teal-300">AL-SALAM</span>',
        'Get in <span class="text-transparent bg-clip-text bg-gradient-to-r from-primary-light to-teal-300">Touch</span>',
        'News & <span class="text-transparent bg-clip-text bg-gradient-to-r from-primary-light to-teal-300">Events</span>',
        'Featured Spotlight',
        'Featured Article',
        'Read Featured Article',
        'All Updates',
        'Dr. Ahmed Yassin',
        'Pharmacist Sarah Rafiq',
        'Dr. Mustafa Jawad',
        'Join Our Team',
        'Full Name *',
        'Email Address *',
        'Phone Number *',
        'Specialized Field / Role *',
        'Select your specialization...',
        'Sterile Production & BFS Operations',
        'Quality Assurance & Microbiological QC',
        'HVAC & Utility Engineering',
        'Regulatory Affairs & Dossiers',
        'Pharmaceutical Supply Chain & Logistics',
        'Commercial Sales & Medical Representative',
        'Years of Experience',
        'e.g. 5 Years in Cleanroom Operations',
        'CV / LinkedIn Profile URL',
        'Qualifications & Cover Note',
        'Summarize your medical/technical background, key qualifications, or link to your online portfolio/CV...',
        'e.g. Dr. Sarah Hassan',
        'Open in Maps',
        'Call Us Direct',
        'Email Channels',
