  ...
  <section class="relative bg-[#041424] min-h-[400px] flex flex-col justify-end pb-16 overflow-hidden">
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full text-center pt-36">
      ...
      <p class="max-w-2xl mx-auto text-base sm:text-lg text-white/70 font-normal leading-relaxed">
        <?php echo wp_kses_post(pll__($meta('_alsalam_hero_subtitle', 'Build your career with Iraq\'s leading sterile pharmaceutical manufacturer. We offer opportunities across R&D, clinical QA, engineering, and commercial operations.'))); ?>
      </p>
    </div>
  </section>
  <?php endif; ?>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
      ...
      <div class="text-center max-w-3xl mx-auto mb-16">
        <span class="inline-block rounded-full bg-[#E5F0F6] px-4 py-1.5 text-xs font-bold tracking-wider text-primary-dark uppercase font-sans mb-3">
          <?php echo esc_html(pll__($meta('_alsalam_joinus_culture_badge', 'Work Culture & Growth'))); ?>
        </span>
        <h2 class="text-3xl sm:text-4xl font-extrabold text-[#071D2C] tracking-tight font-heading leading-tight mb-4">
          <?php echo wp_kses_post(pll__($meta('_alsalam_joinus_culture_title', 'Why Build Your Career with AL-SALAM?'))); ?>
        </h2>
        <p class="text-text-secondary text-sm leading-relaxed">
          <?php echo wp_kses_post(pll__($meta('_alsalam_joinus_culture_desc', 'Join a world-class team of sterile manufacturing specialists, pharmaceutical engineers, and clinical professionals dedicated to setting new benchmarks in Iraq.'))); ?>
        </p>
      </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div class="bg-[#F4F7FE] rounded-[30px] p-8 border border-slate-100 shadow-sm hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 group flex flex-col justify-between">
          <div>
            ...
            <h3 class="text-lg font-bold font-heading text-[#071D2C] mb-2">
              <?php echo esc_html(pll__('European GMP Standards')); ?>
            </h3>
            <p class="text-text-secondary text-sm leading-relaxed">
              <?php echo esc_html(pll__('Work alongside international pharmaceutical standards in state-of-the-art Class A/B cleanroom facilities.')); ?>
            </p>
          </div>
        </div>
        ...
        <div class="bg-[#F4F7FE] rounded-[30px] p-8 border border-slate-100 shadow-sm hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 group flex flex-col justify-between">
          <div>
            ...
            <h3 class="text-lg font-bold font-heading text-[#071D2C] mb-2">
              <?php echo esc_html(pll__('Clinical Development')); ?>
            </h3>
            <p class="text-text-secondary text-sm leading-relaxed">
              <?php echo esc_html(pll__('Structured career progression tracks, continuous aseptic technology workshops, and leadership mentorship.')); ?>
            </p>
          </div>
        </div>
        ...
        <div class="bg-[#F4F7FE] rounded-[30px] p-8 border border-slate-100 shadow-sm hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 group flex flex-col justify-between">
          <div>
            ...
            <h3 class="text-lg font-bold font-heading text-[#071D2C] mb-2">
              <?php echo esc_html(pll__('Cutting-Edge Tech')); ?>
            </h3>
            <p class="text-text-secondary text-sm leading-relaxed">
              <?php echo esc_html(pll__('Operate fully automated Blow-Fill-Seal (BFS) lines and computerized parametric quality assurance systems.')); ?>
            </p>
          </div>
        </div>
        ...
        <div class="bg-[#F4F7FE] rounded-[30px] p-8 border border-slate-100 shadow-sm hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 group flex flex-col justify-between">
          <div>
            ...
            <h3 class="text-lg font-bold font-heading text-[#071D2C] mb-2">
              <?php echo esc_html(pll__('Life-Saving Purpose')); ?>
            </h3>
            <p class="text-text-secondary text-sm leading-relaxed">
              <?php echo esc_html(pll__('Be part of a mission supplying essential Parenteral therapies to critical hospital networks across the nation.')); ?>
            </p>
          </div>
        </div>
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
      ...
      <div class="bg-white rounded-[30px] shadow-xl border border-slate-100 p-8 sm:p-12">
        <div class="border-b border-slate-100 pb-6 mb-8 text-center sm:text-start">
          <span class="inline-block rounded-full bg-[#E5F0F6] px-4 py-1.5 text-xs font-bold tracking-wider text-primary-dark uppercase font-sans mb-3">
            <?php echo esc_html(pll__($meta('_alsalam_joinus_form_badge', 'Careers Intake'))); ?>
          </span>
          <h3 class="text-2xl font-extrabold font-heading text-[#071D2C]"><?php echo esc_html(pll__($meta('_alsalam_joinus_form_title', 'Submit Your Profile'))); ?></h3>
          <p class="text-text-secondary text-sm mt-1"><?php echo esc_html(pll__($meta('_alsalam_joinus_form_desc', 'Fill out your credentials below. Our HR and talent acquisition team will evaluate your clinical or technical experience for relevant vacancies.'))); ?></p>
        </div>
        ...
        <form id="joinus-form" action="<?php echo esc_url(admin_url('admin-ajax.php')); ?>" method="POST" class="space-y-6">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <!-- Phone Number -->
            <div class="flex flex-col gap-2">
              <label for="phone" class="text-xs font-bold text-[#071D2C] uppercase tracking-wider"><?php echo esc_html(pll__('Phone Number *')); ?></label>
            ...
            <!-- Target Department -->
            <div class="flex flex-col gap-2">
              <label for="department" class="text-xs font-bold text-[#071D2C] uppercase tracking-wider"><?php echo esc_html(pll__('Specialized Field / Role *')); ?></label>
              <select id="department" name="department" required class="w-full bg-[#F4F7FE] border border-slate-200/80 rounded-2xl px-5 py-3.5 text-sm text-text-primary focus:outline-none focus:border-primary focus:bg-white transition-all duration-200 appearance-none cursor-pointer">
                <option value="" disabled selected><?php echo esc_html(pll__('Select your specialization...')); ?></option>
                <option value="Sterile Production / BFS"><?php echo esc_html(pll__('Sterile Production & BFS Operations')); ?></option>
                <option value="Quality Assurance & QC"><?php echo esc_html(pll__('Quality Assurance & Microbiological QC')); ?></option>
                <option value="HVAC & Cleanroom Engineering"><?php echo esc_html(pll__('HVAC & Utility Engineering')); ?></option>
                <option value="Regulatory & Pharmacovigilance"><?php echo esc_html(pll__('Regulatory Affairs & Dossiers')); ?></option>
                <option value="Supply Chain & Logistics"><?php echo esc_html(pll__('Pharmaceutical Supply Chain & Logistics')); ?></option>
                <option value="Commercial & Medical Rep"><?php echo esc_html(pll__('Commercial Sales & Medical Representative')); ?></option>
              </select>
            </div>
          </div>
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <!-- Experience Level -->
            <div class="flex flex-col gap-2">
              <label for="experience" class="text-xs font-bold text-[#071D2C] uppercase tracking-wider"><?php echo esc_html(pll__('Years of Experience')); ?></label>
              <input type="text" id="experience" name="experience" placeholder="<?php echo esc_attr(pll__('e.g. 5 Years in Cleanroom Operations')); ?>" class="w-full bg-[#F4F7FE] border border-slate-200/80 rounded-2xl px-5 py-3.5 text-sm text-text-primary placeholder-slate-400 focus:outline-none focus:border-primary focus:bg-white transition-all duration-200">
            </div>

            <!-- CV / LinkedIn URL -->
            <div class="flex flex-col gap-2">
              <label for="cv_url" class="text-xs font-bold text-[#071D2C] uppercase tracking-wider"><?php echo esc_html(pll__('CV / LinkedIn Profile URL')); ?></label>
          ...
          <div class="flex flex-col gap-2">
            <label for="notes" class="text-xs font-bold text-[#071D2C] uppercase tracking-wider"><?php echo esc_html(pll__('Qualifications & Cover Note')); ?></label>
            <textarea id="notes" name="notes" rows="4" placeholder="<?php echo esc_attr(pll__('Summarize your medical/technical background, key qualifications, or link to your online portfolio/CV...')); ?>" class="w-full bg-[#F4F7FE] border border-slate-200/80 rounded-2xl px-5 py-3.5 text-sm text-text-primary placeholder-slate-400 focus:outline-none focus:border-primary focus:bg-white transition-all duration-200 resize-none"></textarea>
          </div>
          ...
          <div class="pt-4 flex justify-end">
            <button type="submit" class="bg-primary hover:bg-primary-dark active:bg-primary text-white text-sm font-semibold px-8 py-3.5 rounded-full shadow-lg shadow-primary/20 transition-all duration-200 transform hover:-translate-y-0.5 cursor-pointer flex items-center gap-2">
              ...
              <span><?php echo esc_html(pll__('Submit Application')); ?></span>
            </button>
          </div>
